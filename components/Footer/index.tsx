...
const Footer: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const contactRows = gsap.utils.toArray('.contact-row');
      if (contactRows.length) {
        gsap.fromTo(
          ...
          { x: 30, opacity: 0 },
          {
            ...
            ease: 'power2.out',
            scrollTrigger: {
              trigger: contactRows[0] as Element,
              start: 'top 94%',
              toggleActions: 'play none none none',
            },
          }
  ...
  return (
    <Box
      ...
      sx={{
        ...
        color: '#fff',
        background:
          'linear-gradient(135deg, #081020 0%, #0b1630 40%, #0a1226 100%)',
      }}
    >
      {/* Background grid */}
      <Box
            ...
            >
              <Box
                sx={{
                  ...
                  transition:
                    'transform .26s ease, box-shadow .26s ease, background .26s ease',
                  '&:hover': {
              ...
              >
                <Box
                  ...
                  sx={{
                    ...
                    width: 'auto',
                    filter:
                      'drop-shadow(0 0 18px rgba(59,130,246,0.38))',
                  }}
                />
                <Typography
                  sx={{
                ...
                <IconButton
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      ...
                      boxShadow: `0 10px 20px ${social.hoverColor}44`,
                    },
                  }}
                >
                  {social.icon}
